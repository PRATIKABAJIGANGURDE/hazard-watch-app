-- INCOIS Hazard Reporting Database Setup for Neon
-- Copy and paste this entire file into Neon SQL Editor and run it

-- Step 1: Enable PostGIS extension for spatial data support
...
-- Step 4: Create Reports table with spatial data support
...
-- Step 5: Create Social posts table (for Phase 2 social media integration)
...
-- Step 6: Create spatial indexes for better query performance
...
-- Step 7: Create regular indexes for common queries
...
-- Step 10: Create function for clustering hotspots (Phase 1 stretch goal)
...
-- Step 11: Insert sample admin user (password: admin123)
INSERT INTO users (name, email, password_hash, role) VALUES 
('Admin User', 'admin@incois.gov.in', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');

-- Step 12: Create view for public report data (excludes sensitive user info)
...
SELECT COUNT(*) as admin_users_created FROM users WHERE role = 'admin';